...
from ..services.field_definition_service import FieldDefinitionService
...
from ..schemas import FieldDefinitionCreate
...
router = APIRouter(tags=["Field Definition Management"])
...
async def get_field_types(
    ...
    from ..models.field_definition_types import FieldType
...
async def get_data_types(
    ...
    from ..models.field_definition_types import FieldDataType
...
async def get_field_permission_types(
    ...
    from ..models.field_definition_types import FieldPermission
